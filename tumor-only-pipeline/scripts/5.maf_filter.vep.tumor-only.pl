=head1
	...
	Options:
		...
		--min-vaf       [0.05]      # minimum tumor vaf
		--min-dep       [20]        # minimum total depth
		--min-mut       [5]         # minimum alternate reads
		--max-indel-len [10]        # minimum indel length
